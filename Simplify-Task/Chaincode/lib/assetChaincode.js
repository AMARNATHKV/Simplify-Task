...
class AssetTransfer extends Contract {
    ...
    async GetUserAssets(ctx) {
        const clientEnrollmentID = this.getClientEnrollmentID(ctx);  
        console.log("Current User ID:", clientEnrollmentID);  // Debugging Line
        ...
        while (true) {
            ...
            if (result.value && result.value.value.toString()) {
                ...
                // Debugging: Print Asset Owner vs User ID
                console.log(`Checking Asset ${asset.ID}, Owner: ${asset.Owner}, User ID: ${clientEnrollmentID}`);
